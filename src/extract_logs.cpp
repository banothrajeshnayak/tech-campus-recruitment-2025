...
void extract_logs(const std::string& date) {
    ...
    std::ifstream infile("C:\\Users\\Rajesh\\tech-campus-recruitment-2025\\logs_2024.log");

    // Define the output file path where extracted logs will be saved
    std::string output_file = "C:\\Users\\Rajesh\\tech-campus-recruitment-2025\\output\\output_" + date + ".txt";
